...
wakeWords = ["hey Ravan", "ok Ravan", "you there Ravan", "wake up Ravan", "hai Ravan", "Ravan are you up", "you up Ravan"]
...
musicWords = ["sing a song", "play music", "music Ravan", "i am feeling groovy"]


edge_path="C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Brave.lnk"
...
def WishMe():
    ...
    playsound.playsound(r"C:\Users\user\OneDrive\Desktop\AI ML Projects\F.R.I.D.A.Y-main\F.R.I.D.A.Y-main\Active Sound Effect.mp3")
    playsound.playsound(r"C:\Users\user\OneDrive\Desktop\AI ML Projects\F.R.I.D.A.Y-main\F.R.I.D.A.Y-main\Boot.mp3")
    ...
    #Speak("Ravan. Version 5.0 . At your service sir")    

def TakeCommand():
    '''
    Enables Ravan to take commands from the user(specifically
...
def GetWeather(city = "kochi"):
    ...
    try:
        wquery = "q=" + city
        res=requests.get('http://api.openweathermap.org/data/2.5/weather?'+wquery+'&APPID=2e6ea0bf6e0c47eda2e93b0bc09eb23b&units=metric')
        result = res.json()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "who are you" in query:
            Speak("I am Ravan, a virtual assistant created by Onkar Ghadigaonkar.")
        ...
        for phrase in shutdownWords:
            if phrase in query:
                ...
                playsound.playsound(r"C:\Users\user\OneDrive\Desktop\AI ML Projects\F.R.I.D.A.Y-main\F.R.I.D.A.Y-main\system shut down sound.mp3")
